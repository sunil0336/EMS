  ...
  return (
    <div className='flex-shrink-0 w-full md:w-1/4 h-full p-5 bg-green-400 rounded-xl flex flex-col'>
      ...
      <p className='text-sm mt-2 flex-1'>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditate, unde? Molestias, vel aliquid? A, voluptatibus?
      </p>
      <div className='flex items-center justify-between gap-2 mt-auto'>
        <button className='bg-green-600 py-1 px-2 text-sm rounded w-1/2'>Task Completed</button>
        <button className='bg-red-600 py-1 px-2 text-sm rounded w-1/2'>Task Failed</button>
      </div>
    </div>
  )
}
